...
> ### 背景
> 
> 近日赋闲在家整理简历，忽然发觉这是一个好机会，可以把自己做过的架构方案、开源项目、技术分享都整理出来！于是创建了这个仓库。这里不仅会有过去的积累，还会不断添加新的收获。对于长年投身业务开发、少有机会接触架构的前端同学来说，可以参考借鉴。
> 
...
2021 年 10 月起入驻子公司 “RJ”，代理技术总监一职，负责架构升级和技术团队管理。
...
### 2018.02～2018.04 · 百姓知道

* 所在公司：百姓网
* 角色：联合项目负责人
* 项目线上地址：<https://zhidao.baixing.com/>
* 项目概述：“百姓知道” 是一个创新孵化项目，是百姓网自建的问答型内容平台，网站支持手机与桌面两种视图。相关技术栈：后端 Python + MongoDB，前端采用 BFF SSR 模式。
* 职责与业绩：
	* 与另一位项目负责人商议架构方案，完成研发落地，共同推进项目目标。
	* 项目成功孵化，至今仍在运营，持续产生营收。
...
* **2016 · 《CSS 揭秘》** <br>
	...
	[![封面](http://www.cssmagic.net/img/book-css-secrets.png)](https://github.com/cssmagic/CSS-Secrets)
...
* **2018 · QCon 上海站 《为什么前端工程师更应该掌握区块链 DApp 开发》** <br>
	...
	[![幻灯片封面](http://www.cssmagic.net/img/video-qcon-dapp.png)](http://www.cssmagic.net/blog/new/97)
...
* **2015 · CSS Conf 《重拾 CSS 的乐趣》** <br>
	...
	[![幻灯片封面](http://www.cssmagic.net/img/video-css-is-fun.png)](http://www.cssmagic.net/blog/new/52)
